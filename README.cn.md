...
[![x-cmd/install — dotstate Code Quality Monitoring Repo Card](https://repo.x-cmd.io/dotstate.svg?lang=zh)](https://x-cmd.com/install/dotstate)
...
- **Star**: 378 · **Fork**: 13 · **开放 issue**: 31 · **贡献者**: 4

## 累计统计

- **发布数**: 43 · **已合并 PR**: 24 · **开放 PR**: 2 · **已关闭 issue**: 28 · **开放 issue**: 3 · **提交数**: 290
...
_数据快照: `data/card/260922.yml` · 2026-09-22T05:27:05Z._
